        ...
        <ThemeProvider theme={theme}>
          ...
          <Card sx={{ background: "#21262d", maxWidth: 820, margin: 'auto', marginBottom: 5, border: '1px solid #30363d' }}>
            ...
            <ProjectTabs
              ...
              tools={'Angular, Express, MongoDB, Redis, Node, Bootstrap'} />
          ...
          <Card sx={{ background: "#21262d", maxWidth: 820, margin: 'auto', marginBottom: 5, border: '1px solid #30363d' }}>
            ...
            <ProjectTabs
              about={`A website for those looking to rent out their islands, and book other people's islands. AirBnB, but for islands.`}
